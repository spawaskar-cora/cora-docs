...
body:
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: >-
        ...
        [More](https://docs/coracore.org/contributing/reporting-a-bug/#context)
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: >-
        ...
        [More](https://docs/coracore.org/contributing/reporting-a-bug/#bug-description)
    validations:
      required: true
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: >-
        ...
        [More](https://docs/coracore.org/contributing/reporting-a-bug/#related-links)
      value: |-
        - [Reporting a bug](https://docs/coracore.org/contributing/reporting-a-bug/)
        -
    validations:
      required: true
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: >-
        ...
        bug. First, read our [reproduction guide](https://docs/coracore.org/guides/creating-a-reproduction/)
        that explains the necessary steps, then use the [built-in info plugin](https://docs/coracore.org/plugins/info/) (mandatory) to create a self-contained
        .zip file with the reproduction. We reserve the right to close issues
        without .zip files.
        [More](https://docs/coracore.org/contributing/reporting-a-bug/#reproduction)
      placeholder: |-
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: >-
        ...
        [More](https://docs/coracore.org/contributing/reporting-a-bug/#steps-to-reproduce)
      placeholder: |-
        1. ...
        2. ...
        3. ...
  ...
  - type: dropdown
    ...
    attributes:
      ...
      description: >-
        ...
        [More](https://docs/coracore.org/contributing/reporting-a-bug/#browser)
      multiple: true
      options:
        - Chrome
        - Safari
  ...
  - type: checkboxes
    ...
    attributes:
      ...
      options:
        - label: >-
            I have read and followed the [bug reporting guidelines](https://docs/coracore.org/contributing/reporting-a-bug/).
          required: true
        - label: >-
          ...
          required: true
        - label: >-
            I assure that I have [removed all customizations](https://docs/coracore.org/contributing/reporting-a-bug/#remove-customizations)
            before submitting this bug report.
          required: true
        - label: >-
            I have attached a __.zip file__ with a [minimal reproduction](https://docs/coracore.org/guides/creating-a-reproduction/).
          required: true