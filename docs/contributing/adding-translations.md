...
It's unbelievable – but CoRA is is used by the global international community 
and with the help of the international community contributions, CoRA seeks to be 
translated into different languages. 
As you can imagine, it's impossible for us maintainers to keep all languages 
up-to-date, and new features sometimes require new translations.

If you would like to help us to make CoRA even more globally
...
With more languages being added, the chances are good that your language is already
supported by CoRA. You can check if your language is available,
...
- __Your language is missing__ – in that case, you can help us add support
  for your language to CoRA! Read on, to learn how to do this.

  [supported languages]: ../getting-started/changing-the-language.md#site-language
...
At this point, when you have made sure that CoRA doesn't already
...
[English translations]: https://github.com/spawaskar-cora/cora-docs/tree/master/src/partials/languages/en.html
...
done a significant contribution to the project, making CoRA
