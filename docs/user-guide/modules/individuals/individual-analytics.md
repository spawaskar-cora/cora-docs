...
![Individual Analytic Nav](media/drilldown/individual_analytics_nav.gif){ width='800' }
...
![Chart Drilldown](media/drilldown/drilldown-chart.png){ width='800' }
...
![Data Table Drilldown](media/drilldown/datatable-drilldown.png){ width='800' }
...
![Complete](media/drilldown/complete-drilldown.png){ width='800' }
...
![DNA Sampled](media/drilldown/dnasampled-drilldown.png){ width='800' }
...
![Measured](media/drilldown/measured-drilldown.png){ width='800' }
...
![CT Scanned](media/drilldown/ctscanned-drilldown.png){ width='800' }
...
![Xray Scanned](media/drilldown/xray-scanned-drilldown.png){ width='800' }
...
![3D Scanned](media/drilldown/3d-scanned-drilldown.png){ width='800' }
...
![Isotope Sampled](media/drilldown/isotope-sampled-drilldown.png){ width='800' }
...
![Methods Sex](media/drilldown/methods-sex-drilldown.png){ width='800' }
...
![Methods Age](media/drilldown/methods-age-drilldown.png){ width='800' }
...
![Methods Ancestry](media/drilldown/methods-ancestry-drilldown.png){ width='800' }