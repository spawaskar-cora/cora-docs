...
![](site-navigation/media/user-profile.png)

### General

![](site-navigation/media/user-general.png)
...
![](site-navigation/media/user-project.png)
...
![](site-navigation/media/user-notification.png)

### Localization

In the Localization tab the user can update their default County, Language and Timezone.

![](site-navigation/media/user-localization.png)
...
![](site-navigation/media/user-last-login.png)
...
![](site-navigation/media/useractivity.png) 
