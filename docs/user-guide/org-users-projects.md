...
![Click on Action](site-navigation/media/org-administration.png)
...
![Click on Action](site-navigation/media/administration-navigation.png)
...
![Click on Action](site-navigation/media/user-management.gif)
...
![Click on Action](site-navigation/media/user-management-create.png)
...
![Click on Action](site-navigation/media/user-management-edit.png)
...
![Click on Action](site-navigation/media/user-management-batch-edit.png)
...
![Click on Action](site-navigation/media/user-management-user-access.png)
...
![Click on Action](site-navigation/media/user-management-reset-password.png)
...
!!! tip
    ...
    2. The column visibility will allow you to add more columns/details to the data table list. 
    3. The Search box can be used to search any details in the data table list.
![Click on Action](site-navigation/media/project-management.gif)
...
![Click on Action](site-navigation/media/project-management-create.png)
...
![Click on Action](site-navigation/media/project-management-edit.png)
...
![Click on Action](site-navigation/media/project-management-batchedit.png)
...
!!! tip
    ...
    2. The column visibility will allow you to add more columns/details to the data table list. 
    3. The Search box can be used to search any details in the data table list.
![Click on Action](site-navigation/media/accession-management.gif)
...
![Click on Action](site-navigation/media/accession-management-create.png)
...
![Click on Action](site-navigation/media/accession-management-edit-.png)
...
![Click on Action](site-navigation/media/instrument-management.gif)
...
![Click on Action](site-navigation/media/instrument-management-create.png)
...
![Click on Action](site-navigation/media/haplogroup-management.gif)
...
![Click on Action](site-navigation/media/haplogroup-management-create.png)
...
![Click on Action](site-navigation/media/haplogroup-management-edit.png)
...
![Click on Action](site-navigation/media/tag-management.gif)
...
![Click on Action](site-navigation/media/tag-management-create.png)
...
![Click on Action](site-navigation/media/tag-management-edit.png)
...
![Click on Action](site-navigation/media/org-profile-about.png)
...
#### General
![Click on Action](site-navigation/media/org-profile-general.png)
...
#### Unit of Measure
![Click on Action](site-navigation/media/org-profile-unit-measure.png)
...
#### Localization
![Click on Action](site-navigation/media/org-profile-localization.png)
...
#### API Keys
![Click on Action](site-navigation/media/org-profile-api-keys.png)
