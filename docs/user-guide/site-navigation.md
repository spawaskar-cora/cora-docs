...
![Welcome Screen](../assets/screenshots/site_navigation/Welcome Screen.png)
...
![Navigation Bar](../assets/screenshots/site_navigation/Navigation bar.png)
...
7. User Avatar (7) - The user avatar shows the user drop down. The user drop down has User Image, User Name and Role (1), the github CoRA docs (2), CoRA Forum (3), CoRA Slack (4), change password link (5), the CoRA-Docs (6), the About (7), the My Profile button (8) and the Logout button (9). The Org Profile button will only be available to the Org admin in which the Org Admin can change the settings of the project.    
   ![Navigation Bar](../assets/screenshots/site_navigation/user_avatar.png)    
...
![Navigation Bar](../assets/screenshots/site_navigation/BoneSearch.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/seSearch.gif) 

##### Composite key

![Navigation Bar](../assets/screenshots/site_navigation/composite.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/CompositeSearch.gif) 
...
**2016-231,X-58,,001**
![Navigation Bar](../assets/screenshots/site_navigation/commaseparatoreg.png) 
...
![Navigation Bar](../assets/screenshots/site_navigation/compostekeyalternatesearch.png) 
   
##### Accession

![Navigation Bar](../assets/screenshots/site_navigation/accesssion.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/AccessionSearch.gif) 

##### Provenance 1
![Navigation Bar](../assets/screenshots/site_navigation/Provenance1.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/Provenance1Search.gif)  
   
##### Provenance 2

![Navigation Bar](../assets/screenshots/site_navigation/Provenance2.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/Provenance2Search.gif)   
   
##### Designator

![Navigation Bar](../assets/screenshots/site_navigation/Designator.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/DesignatorSearch.gif)   

##### Individual Number
   
![Navigation Bar](../assets/screenshots/site_navigation/Individual.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/IndividualSearch.gif)
...
![Navigation Bar](../assets/screenshots/site_navigation/SampleNumber.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/SampleNumberSearch.gif) 

##### Mito Seq Number

![Navigation Bar](../assets/screenshots/site_navigation/MitoSeq.png)  
...
![Navigation Bar](../assets/screenshots/site_navigation/MitoSeqSearch.gif) 

##### External ID

![Navigation Bar](../assets/screenshots/site_navigation/ExternalId.png)  
...
The DNA eg. AFDIL # like 2004H2001 or 2015HO860 indicates you are searching for the DNA either by external id '2004H2001' or '2015HO860' etc. In order to search for the DNA, you just have to give the external id without the lab name as shown below.
   ![Navigation Bar](../assets/screenshots/site_navigation/extideg.png)
...
![Navigation Bar](../assets/screenshots/site_navigation/ExternalIdSearch.gif) 
...
![LeftsideBar](../assets/screenshots/site_navigation/leftsidebar_anthro.png) 
...
The Right side bar includes the 4 different tabs and each of the tabs includes the user specific settings. The following are the tabs in the right side bar -
   ...
   ![RightsideBar](../assets/screenshots/site_navigation/rightsidebar.png)
 
### Layout and Skin Tab  
   
Layout and Skin Tab (1) - The Layout tab includes the Layout Option (2) and Skins (3).      
  
  ![layout](../assets/screenshots/site_navigation/layout_options_settings.png)
...
The Layout Options (2) allows the user to make changes in the layout of the app. The following are the description of the options in layout-
  ...
  ![layout](../assets/screenshots/site_navigation/layout_options.png)
   ...
   ![layout](../assets/screenshots/site_navigation/skins.png)
...
![help](../assets/screenshots/site_navigation/help.png)    
...
![activityFeed](../assets/screenshots/site_navigation/activity_feed.png)        
...
![settings](../assets/screenshots/site_navigation/general_se_update.png)
![settingsDNA](../assets/screenshots/site_navigation/dna_update.png) 
...
![settings](../assets/screenshots/site_navigation/app_container.png)
