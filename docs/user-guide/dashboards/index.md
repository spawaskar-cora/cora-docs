...
![](media/dashboard-widget.png){ width="400" }
...
![](media/mouse-over-data.png){ width="400" }
...
* Help-Cora Docs
  ![](media/widget-control-help.png){ width="400" }
...
![](media/semi-circle-widget.png){ width="400" }

![](media/semi-circle-pie-chart.png){ width="400" }
...
![](media/full-circle-widget.png){ width="400" }

![](media/full-circle-pie-chart.png){ width="400" }

3. Show Donut:- Clicking on Donut option provides a dynamic donut view of data representation.

![](media/donut-widget.png){ width="400" }

![](media/donut-pie-chart.png){ width="400" }

4. Show Pie:- Clicking on Pie option provides a dynamic Pie view of data representation.

![](media/pie-widget.png){ width="400" }

![](media/pie-chart-main.png){ width="400" }
...
![](media/bar-graph-all.png){ width="500" }
![](media/stacked-bar-graph-all.png){ width="500" }

If the toggle switch is activated, bar graph/stacked bar graph would show data related to MNI Only

![](media/bar-graph-mni.png){ width="500" }
...
![](media/line-step-options.png){ width="200" }
...
![](media/line-step.png){ width="500" }

### Days

Days is a dropdown which shows 4 options to select from

![](media/days-options.png){ width="200" }
...
![](media/point-style.png){ width="500" }
